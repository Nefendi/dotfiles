...
local mappings = {
    ...
    { "<leader>Lc", "<cmd>TexlabCleanArtifacts<cr>", desc = "Clean Artifacts", nowait = true },
    { "<leader>LC", "<cmd>TexlabCleanAuxiliary<cr>", desc = "Clean Auxiliary", nowait = true },
    { "<leader>Lb", "<cmd>TexlabBuild<cr>", desc = "Build", nowait = true },
    { "<leader>LB", "<cmd>TexlabCancelBuild<cr>", desc = "Cancel Build", nowait = true },
    ...
    { "<leader>Lv", "<cmd>TexlabForward<cr>", desc = "View PDF/Forward Search", nowait = true },
