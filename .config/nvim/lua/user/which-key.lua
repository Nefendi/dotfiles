...
local mappings = {
    ...
    g = {
        ...
        c = {
            name = "+Conflicts",
            c = { "<cmd>GitConflictChooseOurs<cr>", "Accept Current Changes" },
            i = { "<cmd>GitConflictChooseTheirs<cr>", "Accept Incoming Changes" },
            ...
            s = { "<cmd>GitConflictListQf<cr>", "Show Conflicts" },
        },
